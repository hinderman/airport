...
public class FlightServiceImp implements FlightService{
    ...
    @Override
    public List<Flight> findFlightByFilters(String departureAirportName, String arrivalAirportName, String departureDate){
        List<Flight> a = _FlightRepository.findFlightByFilters(departureAirportName, arrivalAirportName, departureDate);
        return a;
    }
